-- Refresh get_my_school so the student_count excludes deactivated students —
-- a swapped-out rep must not keep inflating the school's roster. Otherwise
-- identical to …021. Idempotent. Run after student_replacements.
